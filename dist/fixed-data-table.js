...
})(this, function(__WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_63__) {
  ...
  _createClass(FixedDataTableRowImpl, [{
    ...
    value: function render() /*object*/{
      ...
      return _React2.default.createElement(
        ...
        _React2.default.createElement(
          'div',
          { className: (0, _cx2.default)('fixedDataTableRowLayout/rowFooter') },
          'moshe'
        ),
        subRowsCount && _React2.default.createElement(
          'div',
          {
            className: (0, _cx2.default)('fixedDataTableRowLayout/subRow'),
            style: rowExpandedStyle
          },
          Array(subRowsCount).fill(null).map(function (dummy, index) {

            var subRowPath = _this2.props.subRowPath ? _this2.props.subRowPath + '.' + index : index.toString();

            var topOffset = _this2.props.subRowTopOffsetGetter({ rowIndex: _this2.props.index, subRowPath: subRowPath });

            var subRowStyle = {
              top: _this2.props.height * (index + 1 + topOffset),
              position: 'absolute'
            };

            return _React2.default.createElement(
              'div',
              { style: subRowStyle, key: subRowPath },
              _React2.default.createElement(FixedDataTableRowImpl, _extends({}, _this2.props, { subRowPath: subRowPath }))
            );
          })
        ),
        columnsRightShadow
...
FixedDataTableRowImpl.propTypes = {
  ...
  rowSubRowsCountGetter: _propTypes2.default.func,

  subRowTopOffsetGetter: _propTypes2.default.func,
  ...
  subRowPath: _propTypes2.default.string
};
...
var _FixedDataTableRow = __webpack_require__(31);
...
var FixedDataTableRoot = {
  ...
  Row: _FixedDataTableRow2.default
};
  ...
  render: function render() /*object*/{
    ...
    for (var i = 0; i < rowsToRender.length; ++i) {
      ...
      this._staticRowArray[i] = _React2.default.createElement(_FixedDataTableRow2.default, {
        ...
        rowSubRowsCountGetter: props.rowSubRowsCountGetter,
        subRowTopOffsetGetter: props.subRowTopOffsetGetter,
...
var FixedDataTableCell = (0, _createReactClass2.default)({
  ...
  render: function render() /*object*/{
    var _props2 = this.props,
        ...
        subRowPath = _props2.subRowPath,
        props = _objectWithoutProperties(_props2, ['height', 'width', 'columnKey', 'subRowPath']);
